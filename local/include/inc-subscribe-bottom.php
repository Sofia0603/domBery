...
<div id="subscribe" class="popup-mini" style="display: none;">
    ...
    <form id="subscribeForm" class="form-ajax row gx-2">
        ...
        <div class="col-12 mb-3">
            <input class="btn btn-primary btn-lg btn-block" type="submit" name="submit" value="Отправить">
        </div>
    </form>
    
    <div id="thankYouMessage" style="display: none;">
        <h2>
            Благодарим за вашу подписку! Теперь вы будете регулярно получать наши новости!
        </h2>
    </div>
</div>
