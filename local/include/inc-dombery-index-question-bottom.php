<div class="gray-bg p-4 p-lg-5 rounded-lg mt-5">
    ...
    <div class="mb-3">
        <span class="gray">Свяжитесь с нами по телефону</span> <a href="tel:+7(495)1093339">+7&nbsp;(495)&nbsp;109-33-39</a> <span class="gray">или заполните и отправьте форму ниже, и мы с удовольствием с Вами свяжемся и обо всём расскажем.</span>
    </div>
