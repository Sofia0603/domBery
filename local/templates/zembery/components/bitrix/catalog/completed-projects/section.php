...
$sortType = ( $_REQUEST['sort'] ? $_REQUEST['sort'] : ($_SESSION['build_sort'] ? $_SESSION['build_sort'] : 'show_asc') );
...
<? /* <div class="font-14 mb-4 form-row align-items-center">
    ...
    <div class="col-auto <?=($sortField !== 'PROPERTY_ONELINE_AREA' ? 'gray':'')?> ">
        <a href="?sort=square_<?=($sortOrder == 'ASC' ? 'desc' : 'asc')?>">
            Площади
            <?=( $sortType == 'square_asc' ? '<i class="fal fa-long-arrow-down ms-1"></i>' : ($sortType == 'square_desc' ? '<i class="fal fa-long-arrow-up ms-1"></i>' : '') )?>
        </a>
    </div>
</div> */ ?>
