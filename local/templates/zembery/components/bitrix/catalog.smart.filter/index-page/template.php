...
<div class="smart-filter sale__filters <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "smart-filter-horizontal"?>">
			...
			<div class="row align-items-center">
					...
					foreach($arResult["ITEMS"] as $key=>$arItem)
					{
						...
						if ($arItem["DISPLAY_TYPE"] == "A" && ( $arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"] <= 0))
							continue;
						?>
                    <div class="btn-group smart-filter-group col-12 col-sm">
                        <? if($arItem["NAME"] !== 'Преимущества посёлка'):?>
						<div class="btn-group flex-grow-1 ">
							<button type="button" class="btn btn-md-lg btn-light dropdown-toggle sale__select" data-bs-toggle="dropdown" data-bs-auto-close="outside">
								<span class="pe-3">
									<?=$arItem["NAME"]?>
				...
				<div class="col-12 col-md-auto">
								<input
									class="btn btn-block sale__button"
									type="submit"
									id="set_filter"
									name="set_filter"
