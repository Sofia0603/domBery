...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as &$arItem):
        $arItem['IBLOCK'] = CIBlockElement::GetByID($arItem["ITEM_ID"])->GetNext();
        $img = CFile::ResizeImageGet($arItem['IBLOCK']['PREVIEW_PICTURE'] ? $arItem['IBLOCK']['PREVIEW_PICTURE'] : $arItem['IBLOCK']['DETAIL_PICTURE'], array('width'=>320, 'height'=>280), BX_RESIZE_IMAGE_PROPORTIONAL, false, false, false, 80);
        ?>
        <div class="row position-relative">
            ...
            <div class="col position-static">
                <a class="font-20 mb-2 d-block stretched-link" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>

                <p><?echo $arItem["BODY_FORMATED"]?></p>

                <? if($arItem["CHAIN_PATH"] || $arItem['PARAM2'] == 1): ?>
                    <div class="strong font-12">
                        <? if($arItem['PARAM2'] == 1)
                            echo '<a href="/catalog/">Поселки</a>';
                        else
