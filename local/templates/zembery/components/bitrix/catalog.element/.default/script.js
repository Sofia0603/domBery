...
$(document).ready(function(){
    ...
    $('.jsCompare').click(function(){
            ...
            $.get("/local/include/ajax-compare-action.php",
                ...
                function(data) {
                    ...
                    popupmsg('<div class="text-center"><h5>' + data.MESSAGE + '</h5><br>' +
                        ...
                        '<a class="btn btn-primary me-4" href="/compare/">Сравнить</a> <a class="btn btn-outline-primary" href="/catalog/">Добавить еще к сравнению</a>')
        ...
        let sliderItems = document.querySelectorAll(".detail-slider-item");
