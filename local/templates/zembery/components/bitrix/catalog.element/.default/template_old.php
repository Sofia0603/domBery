        ...
        <? if ($arResult['DISPLAY_PROPERTIES']['PRICE_PER_SQUARE']) { ?>
            ...
            <div id="price_subscribe" class="popup" style="display:none;">
                ...
                <div class="darkgray-bg rounded-lg px-3 pt-3">
                    <form class="form-ajax row gx-2 justify-content-center" action="/local/include/ajax-price-subscribe.php">
...
//                                    echo '</pre>';
            ...
            <div class="tab-pane fade" id="kadastr" role="tabpanel">
