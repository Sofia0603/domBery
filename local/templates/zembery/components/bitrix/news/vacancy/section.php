...
echo '</div>';
?>
<div class="mt-n5 py-5" style="background: no-repeat url(<?=CFile::GetPath($arIblock['PICTURE'])?>) center / cover;">
...
<div>
	...
	<div class="p-4 rounded-lg col-12 col-lg-12" style="background: #F4F6FB;">
		<div class="">
			<img class="mb-4" src="/images/ico-question-green.svg" />
			<h2>
				Устроиться на работу - легко
			</h2>

			<div class="gray mb-3">
				Если выше есть ваша специализация, то просто нажмите кнопку ниже и заполните форму!
			</div>

			<a class="btn btn-lg btn-primary btn-block" href="#resume" data-fancybox >Хочу работу</a>
		</div>
		...
		<div id="resume" class="popup-mini" style="display: none;">
			...
			<form class="form-ajax row gx-2">
                ...
                <div class="col-12 col-md-6 input-group mb-3 mb-md-0">
