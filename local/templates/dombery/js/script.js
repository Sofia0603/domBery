...
jQuery(document).ready(function($){
    ...
    $('.form-ajax').submit(function(){
        ...
        if (url == undefined) url = '/local/include/ajax-feedback-dombery.php';
        $.ajax({
            url: url,
            method: 'POST',
            dataType: 'json',
    ...
    $('.detail-dombery-slider').slick({
        ...
        infinite: true,
        variableWidth: false,
        //asNavFor: '.detail-dombery-slider-nav',
        responsive: [

        ]
    });
    $('.detail-dombery-slider-nav').slick({
        slidesToShow: 8,
        slidesToScroll: 1,
        dots: false,
        arrows: false,
        infinite: false,
        variableWidth: true,
        asNavFor: '.detail-dombery-slider',
        focusOnSelect: true,
        responsive: [
