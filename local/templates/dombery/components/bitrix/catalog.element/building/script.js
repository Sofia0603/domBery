...
$(document).ready(function(){
    ...
    $('.jsCompare').click(function(){
        ...
        if ( $(this).hasClass("green") ) {
            $(this).removeClass("green");
            $.get("/local/include/ajax-building-compare-action.php",
                {
                ...
                function(data) {
                    ...
                    popupmsg('<div class="text-center"><h5>' + data.MESSAGE + '</h5><br>' +
                        ...
                        '<a class="btn btn-primary mr-4" href="/building/compare/">Сравнить</a> <a class="btn btn-outline-primary" href="/building/">Добавить еще к сравнению</a>')
