...
$sortType = ( $_REQUEST['sort'] ? $_REQUEST['sort'] : ($_SESSION['sort'] ? $_SESSION['sort'] : 'price_asc') );
...
<div class="font-14 mb-4 form-row align-items-center">
    ...
    <div class="col-auto <?=($sortField !== 'PROPERTY_REMOTENESS' ? 'gray':'')?> ">
        <a href="?sort=remoteness_<?=($sortOrder == 'ASC' ? 'desc' : 'asc')?>">
            Удаленности
            <?=( $sortType == 'remoteness_asc' ? '<i class="fal fa-long-arrow-down ml-1"></i>' : ($sortType == 'remoteness_desc' ? '<i class="fal fa-long-arrow-up ml-1"></i>' : '') )?>
        </a>
    </div>
</div>
